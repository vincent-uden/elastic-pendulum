orig_data = readmatrix("../CSV Data/J/J1_origin_pos.csv");
origin = mean(orig_data, 1) + [-24.0504, -10.9529, -15.1941];

paths = dir("../CSV Data/J/J*_pos.csv");
time = 50;
t0 = 200;
...
for p = 1:3
    real_data = readmatrix(strcat("../CSV Data/J/", paths(p).name));
    ...
    plot3(real_output(1:200,1,p), real_output(1:200,2,p), real_output(1:200,3,p), 'color', rand(1,3));
